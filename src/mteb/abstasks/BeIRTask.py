...
class BeIRTask(AbsTask):
    ...
    def load_data(self, eval_splits=None, data_folder=None, **kwargs):
        """
        ...
        for split in eval_splits:
            if USE_BEIR_DEVELOPMENT:
                ...
                download_path = data_folder if data_folder else os.path.join(datasets.config.HF_DATASETS_CACHE, "BeIR")
