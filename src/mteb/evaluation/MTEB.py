...
class MTEB:
    ...
    def run(self, model, verbosity=1, output_folder="results/result", eval_splits=None, overwrite_results=False,
        ...
        while len(self.tasks) > 0:
            ...
            try:
                ...
                task.load_data(eval_splits=task_eval_splits, data_folder=data_folder)
